...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: `${process.env.NEXT_PUBLIC_IMAGE_BASE_URL}properties/images/abic-realty-banner.png`,
  ...
  icons: {
    ...
    apple: `${process.env.NEXT_PUBLIC_IMAGE_BASE_URL}media/abic-apple-icon.png`,
